...
import uy.dental.config.audit.AuditEventConverter;
import uy.dental.domain.PersistentAuditEvent;
...
import static uy.dental.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
